  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 pt-1">
      ...
      <input
        ...
        className="flex-1 min-w-0 px-3 py-2 rounded-lg border border-[var(--c-border)] bg-[var(--c-surface)] text-sm text-[var(--c-ink)] placeholder:text-[var(--c-ink-2)]/50 focus:border-indigo-500/50"
      />
      <button
        onClick={onSubscribe}
        disabled={saving}
