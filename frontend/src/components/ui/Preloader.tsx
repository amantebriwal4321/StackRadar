    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[99999] flex items-center justify-center overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-0 left-0 w-full h-1/2 bg-[#050810] border-b border-[#2563EB]/15 pointer-events-auto"
        />
        ...
        <motion.div
          ...
          animate={progress === 100 ? { y: "100%" } : { y: 0 }}
          transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
          className="absolute bottom-0 left-0 w-full h-1/2 bg-[#050810] pointer-events-auto"
        />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center space-y-4">
          <motion.div 
            ...
            className="text-sm font-bold tracking-[0.4em] font-display text-[#8899BB] uppercase text-center"
          >
            STACKRADAR
          </motion.div>
          <div className="text-7xl md:text-9xl font-black font-display text-[#2563EB] tracking-tighter leading-none select-none">
            {progress}%
          </div>
        </div>
      </div>
