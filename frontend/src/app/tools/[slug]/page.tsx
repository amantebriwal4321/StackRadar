...
export default function ToolDetailPage() {
    ...
    return (
      <DashboardShell>
        <div className="flex flex-col items-center justify-center py-32 gap-3">
          ...
          <span className="text-xs font-mono text-[var(--c-ink-2)]/70">Accessing tool core telemetry...</span>
        </div>
      </DashboardShell>
    );
  }
      ...
      <DashboardShell>
        <div className="flex items-center justify-center py-32 text-muted-foreground">
          <div className="text-center space-y-4 max-w-sm glass-panel p-8 rounded-xl border border-indigo-500/10">
            ...
            <Link href="/" className="inline-block text-xs font-mono bg-indigo-600 hover:bg-indigo-500 text-[var(--c-ink)] px-4 py-2 rounded">
              RETURN_TO_DASHBOARD
            </Link>
          </div>
        </div>
  ...
  const growthColor = tool.growth_pct > 0 ? "text-emerald-600" : tool.growth_pct < 0 ? "text-rose-600" : "text-[var(--c-ink-2)]/70";
  ...
  return (
    <DashboardShell>
      ...
      <div className="space-y-8 relative z-10 pb-16">
        ...
        {/* Back Link */}
        <Link href="/" className="inline-flex items-center text-xs font-mono text-[var(--c-ink-2)] hover:text-[var(--c-ink)] transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-6">
          ...
          {/* Large Core Score badge + save action */}
          ...
          <div className="lg:col-span-8 tech-panel p-6 rounded-2xl flex flex-col justify-between">
            ...
            {history.length > 1 ? (
              ...
              <div className="h-60 flex flex-col items-center justify-center text-center p-6 space-y-3">
                ...
                <p className="text-xs font-mono text-[var(--c-ink-2)]">Collecting temporal data logs. Requires 48 hours scan period.</p>
              </div>
            )}
          </div>
          ...
          <div className="lg:col-span-4 tech-panel p-6 rounded-2xl flex flex-col justify-between items-center text-center relative">
            ...
            <div className="relative w-44 h-44 flex items-center justify-center my-2">
              <svg width="170" height="170" viewBox="0 0 170 170" className="transform -rotate-90">
                {/* Dial background */}
                <circle cx="85" cy="85" r="75" style={{ stroke: "var(--c-border)" }} strokeWidth="6" fill="none" />
            ...
            <div className="w-full flex justify-between font-mono text-[10px] text-[var(--c-ink-2)] pt-4 border-t border-indigo-500/5">
        ...
        {tool.github_repo && (
          ...
          >
            <div className="p-2.5 bg-[var(--c-surface-2)] border border-[var(--c-border)] rounded-lg group-hover:scale-105 transition-all">
              <Github className="w-5 h-5 text-[var(--c-ink)] group-hover:text-indigo-600" />
            </div>
            <div>
