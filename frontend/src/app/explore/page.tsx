...
function priorityStyle(p: string): { label: string; cls: string } {
  switch ((p || "").toUpperCase()) {
    case "HIGH": return { label: "High priority", cls: "text-emerald-600 bg-emerald-500/10 border-emerald-500/20" };
...
export default function ExplorePage() {
  ...
  // Pick up a query handed off from the landing console (/explore?q=…)
  useEffect(() => {
